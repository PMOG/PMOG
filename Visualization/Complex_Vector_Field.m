...
% Elipse
a=(I+L)/2; % Semieje mayor
b=(I-L)/2; % Semieje menor
phi=atan2(U,Q)/2; % Angulo con respecto a eje x
h=sign(V); % Signo de orientacion de elipse (+ Left-Hand = Blue. - Right-Hand = Red)
